...
public class ExtentManager extends TestListenerAdapter {
    ...
    public void onStart(ITestContext testContext)
    {
        ...
        htmlReporter=new ExtentHtmlReporter(System.getProperty("user.dir")+"/Reports/ExtentReport1.html");           // htmlReporter.loadXMLConfig(System.getProperty("user.dir")+ "/Extent-config.xml");
